...
// מתח כניסה. בשוק הישראלי רלוונטי רק מתח הרשת 220-240VAC: "230V" הוא
// הטווח הזה (אומת מול דף הנתונים של BRICK060), ו-"110V" — גם אם הדרייבר
// universal — עובד בו באותה מידה. מתחי DC משניים (12V/24V/48V) הם דרייברים
// שניזונים ממקור אחר ונשארים נפרדים.
const INPUT_VOLTAGE_MAP = {
  '110V': 'AC 220-240V',
  '230V': 'AC 220-240V',
  '100÷250V AC': 'AC 100-250V',
  'DALI': 'DALI',
};
