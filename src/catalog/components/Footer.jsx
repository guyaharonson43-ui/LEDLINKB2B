        ...
        <div className="footer-top">
          <div>
            <div style={{ direction: 'ltr', display: 'inline-flex', alignItems: 'center', gap: '2px' }}>
              <span className="footer-logo-led">LED</span>
              <span className="footer-logo-link">LINK</span>
            </div>
          ...
          <div>
            ...
            <div className="footer-links">
              <a href="tel:+97286326059" className="footer-link">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.6 1.22h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.8a16 16 0 0 0 6 6l1-1.06a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 21.72 16z"/>
                </svg>
                08-632-6059
              </a>
              ...
              <a href="https://wa.me/972524444470" target="_blank" className="footer-link">
